    ...
    <div className="flex flex-wrap gap-3">
      {items.map((item) => (
        <a
          ...
          className="terminal-card card-3d-hover inline-flex items-center gap-2 rounded-lg px-4 py-2.5 font-mono text-sm text-terminal-cyan transition-colors hover:text-terminal-green"
        >
